...
const Addnotes = (props) => {
  ...
  function submithandle(e)
  {
    e.preventDefault();
    console.log(status);
    axios.post('http://localhost:3001/api/update',{ide:localStorage.getItem('userEmail'),status:status,pagefinsh:pages,rating:rating,notes:notes,bookid:bookid,readgain:readagain} )
        .then((data)=>{
        {showNotification("tl")}
    });
